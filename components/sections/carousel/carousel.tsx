            ...
            {items.map((item, index) => (
              <div
                ...
                className={cn(
                  ...
                  item.type === 'cta'
                    ? 'basis-[199px]'
                    : 'basis-[320px] md:basis-[380px] lg:basis-[421px]'
                )}
                role="listitem"
              >
                {item.type === 'image' ? (
                  ...
                  <a
                    ...
                    className="flex h-80 flex-col justify-between bg-primary px-4 py-6 transition-transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 md:h-[380px] lg:h-[421px]"
                    aria-label="Odwiedź nasz Instagram"
                  >
                    <div className="flex flex-col justify-center">
                      <p className="font-montserrat text-lg font-semibold leading-normal text-[#1a1a1a] underline decoration-solid underline-offset-2">
                        {item.text}
                      </p>
                    </div>
